...
public abstract class SyntaxHighlighterBase {
    ...
    public SyntaxHighlighterBase configure(@Nullable final Paint paint) {
        if (_editorConfig != null) {
            _isDarkMode = _editorConfig.isDarkModeEnabled();
            _fontFamily = _editorConfig.getFontFamily();
            _textColor = _editorConfig.getEditorForegroundColor();
            if (paint != null) {
                _tabSize = (int) (_editorConfig.getTabWidth() * paint.measureText(" "));
            }
        }
        return this;
    }
    ...
    protected final EditorConfig _editorConfig;
    ...
    public SyntaxHighlighterBase(final EditorConfig config) {
