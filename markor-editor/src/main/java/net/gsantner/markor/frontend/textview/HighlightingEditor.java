...
public class HighlightingEditor extends AppCompatEditText {
    ...
    private static EditorConfig _editorConfig;

    public static void setDefaultConfig(EditorConfig config) {
    ...
    public HighlightingEditor(Context context, AttributeSet attrs) {
        ...
        _isSpellingRedUnderline = _editorConfig == null || !_editorConfig.isSpellingRedUnderlineEnabled();
